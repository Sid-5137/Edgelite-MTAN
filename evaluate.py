...
from utils.metrics import (depth_metrics, segmentation_metrics, 
                           normal_metrics, MetricAccumulator)
...
def main():
    ...
    # Evaluate
    results = evaluate(
        model, val_loader, device, CATEGORY_GROUPS,
        args.output_dir, num_vis=args.num_vis,
    )
